                ...
                <div class="content">
                    <form class="login-form" role="form" method="POST" action="<?php echo e(route('frontend.login')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9"><input type="text" class="form-control placeholder-no-fix" name="email" value="<?php echo e(old('email')); ?>" autocomplete="off" placeholder="Email"></div>
                        </div>
                        ...
                        <div class="form-actions row">
                            <div class="col-md-9 pull-right">
                                ...
                                <button type="submit" class="btn btn-site pull-right"><?php echo e(__('account.login')); ?></button>
                            </div>
                        </div>
