...
<li>
    <a href="<?php echo e(route('admin.page.index', ['type'=>$type])); ?>"> <?php echo e($pageTitle); ?> </a>
...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="<?php echo e(route('admin.page.update',['id'=>$item->id,'type'=>$type])); ?>" enctype="multipart/form-data" >
        <?php echo e(csrf_field()); ?>

        <?php echo e(method_field('put')); ?>

        <input type="hidden" name="redirects_to" value="<?php echo e(url()->full()); ?>" />
