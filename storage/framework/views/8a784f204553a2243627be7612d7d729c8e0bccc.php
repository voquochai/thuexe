...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/css/member.css')); ?>">
...
<body <?php echo $site['class'] ? 'class="'.$site['class'].'"' : ''; ?> >
    ...
    <div class="wrapper">
        ...
        <section class="page-section ptb-60">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12"><?php echo $__env->make('frontend.member.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></div>
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12"><?php echo $__env->yieldContent('content'); ?></div>
                </div>
            </div>
        </section>
