    ...
    <div class="header-top">
        <div class="container">
            <div class="header-top-left">
                <ul>
                    <li> <a href="tel:<?php echo e(config('settings.site_hotline')); ?>"> <i class="fa fa-phone"></i> <span><?php echo e(config('settings.site_hotline')); ?></span> </a> </li>
                    <li> <a href="mailto:<?php echo e(config('settings.site_email')); ?>"> <i class="fa fa-envelope"></i> <span><?php echo e(config('settings.site_email')); ?></span> </a> </li>
                </ul>
            </div>
