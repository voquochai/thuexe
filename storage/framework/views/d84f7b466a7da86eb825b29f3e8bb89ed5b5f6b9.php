	...
	<div class="col-md-12">
		<div class="portlet box green">
			<div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?php echo e(route('qlyxe.order.create',['type'=>$type])); ?>" class="btn btn-sm btn-default"> Thêm mới </a>
                    <div class="btn-group">
					...
					<table class="table table-bordered table-condensed">
						...
						<tbody>
                            ...
                            <tr id="record-<?php echo e($item->id); ?>">
                                ...
                                <td align="center">
                                    <a href="<?php echo e(route('qlyxe.order.edit',['id'=>$item->id, 'type'=>$type])); ?>" class="btn btn-sm blue" title="Chỉnh sửa"> <i class="fa fa-edit"></i> </a>
                                    <form action="<?php echo e(route('qlyxe.order.delete',['id'=>$item->id, 'type'=>$type])); ?>" method="post">
