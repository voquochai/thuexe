...
<li>
    <a href="<?php echo e(route('qlyxe.category.index', ['type'=>$type])); ?>"> <?php echo e($pageTitle); ?> </a>
...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="<?php echo e(route('qlyxe.category.update',['id'=>$item->id,'type'=>$type])); ?>" enctype="multipart/form-data" >
