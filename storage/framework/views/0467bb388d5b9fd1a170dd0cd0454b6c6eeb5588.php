                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="content">
                                <form class="register-form" role="form" method="POST" action="<?php echo e(route('frontend.register')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 col-sm-12 col-xs-12">
                                            <select class="form-control province" name="province_id">
                                                <?php echo e(old('province_id') ? '<option value="'.old('province_id').'" selected ></option>' : ''); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 col-sm-12 col-xs-12">
                                            <select class="form-control district" name="district_id">
                                                <?php echo e(old('district_id') ? '<option value="'.old('district_id').'" selected ></option>' : ''); ?>
                                    ...
                                    <div class="form-actions row">
                                        <div class="col-md-9 col-sm-12 col-xs-12 pull-right">
                                            <button type="button" data-target="#ajax-modal-login" class="btn" data-toggle="modal" data-dismiss="modal"><?php echo e(__('account.back')); ?></button>
