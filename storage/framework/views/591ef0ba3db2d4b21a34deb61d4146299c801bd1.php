	...
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?php echo e(route('admin.post.create',['type'=>$type])); ?>" class="btn btn-sm btn-default"> Thêm mới </a>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li>
                                <a href="javascript:;" class="btn-action" data-type="<?php echo e($key); ?>" data-ajax="act=update_status|table=posts|col=status|val=<?php echo e($key); ?>"> <?php echo e($act); ?> </a>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="javascript:;" class="btn-action" data-type="delete" data-ajax="act=delete_record|table=posts|config=post|type=<?php echo e($type); ?>"> Xóa dữ liệu </a>
                            </li>
                        </ul>
                    </div>
                </div>
					...
					<table class="table table-bordered table-condensed">
						...
						<tbody>
                            ...
                            <tr id="record-<?php echo e($item->id); ?>">
                                ...
                                <td align="center"> <input type="text" name="priority" class="form-control input-mini input-priority" value="<?php echo e($item->priority); ?>" data-ajax="act=update_priority|table=posts|id=<?php echo e($item->id); ?>|col=priority"> </td>
                                <?php if($siteconfig[$type]['category']): ?>
                                <td align="center"> <?php echo e($item->category); ?> </td>
                                <?php endif; ?>
                                <td align="center"><a href="<?php echo e(route('admin.post.edit',['id'=>$item->id, 'type'=>$type])); ?>"> <?php echo e($item->title); ?> </a></td>
                                <?php if($siteconfig[$type]['image']): ?>
                                ...
                                <td align="center">
                                    <?php $__currentLoopData = $siteconfig[$type]['status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyS => $valS): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button class="btn btn-sm btn-status btn-status-<?php echo e($keyS); ?> btn-status-<?php echo e($keyS.'-'.$item->id.' '.((strpos($item->status,$keyS) !== false)?'blue':'default')); ?>" data-loading-text="<i class='fa fa-spinner fa-pulse'></i>" data-ajax="act=update_status|table=posts|id=<?php echo e($item->id); ?>|col=status|val=<?php echo e($keyS); ?>"> <?php echo e($valS); ?> </button>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </td>
                                <td align="center">
                                    <a href="<?php echo e(route('admin.post.edit',['id'=>$item->id, 'type'=>$type])); ?>" class="btn btn-sm blue" title="Chỉnh sửa"> <i class="fa fa-edit"></i> </a>
                                    <form action="<?php echo e(route('admin.post.delete',['id'=>$item->id, 'type'=>$type])); ?>" method="post">
