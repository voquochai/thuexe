<div class="page-sidebar-wrapper">
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu page-header-fixed page-sidebar-menu-light" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            ...
            <li class="nav-item">
                <a href="{{ route('qlyxe.product.quickly',['type'=>'thue-xe']) }}" data-route="product.thue-xe" class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('qlyxe.order.index',['type'=>'thue-xe']) }}" data-route="order.thue-xe" class="nav-link">
                    <i class="icon-exclamation"></i>
