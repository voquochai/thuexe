...
@section('breadcrumb')
<li>
    <a href="{{ route('admin.permission.index') }}"> Quyền quản trị </a>
...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="{{ route('admin.permission.update',['id'=>$item->id]) }}" enctype="multipart/form-data" >
        {{ csrf_field() }}
        {{ method_field('put') }}
