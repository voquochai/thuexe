                    ...
                    redesign: function() {
                        ...
                        if (n.changeInput) {
                            switch ((typeof n.changeInput + "").toLowerCase()) {
                                case 'boolean':
                                    o = $('<div class="fileuploader-input">' + '<div class="fileuploader-input-caption"><span>' + f._assets.textParse(n.captions.feedback) + '</span></div>' + '<div class="fileuploader-input-button"><span class="btn btn-info">' + f._assets.textParse(n.captions.button) + '</span></div>' + '</div>');
                                    break;
                                case 'string':
                    ...
                    upload: {
                        ...
                        send: function(item, force_send) {
                            ...
                            item.upload.success = function(data, textStatus, jqXHR) {
                                if (item.upload.chunk && !item.upload.chunk.isLast) return;
                                delete item.upload.chunk;
    ...
    $.fn.fileuploader.defaults = {
        ...
        captions: {
            button: function(options) {
                return '<i class="fa fa-plus"></i> Choose ' + (options.limit == 1 ? 'File' : 'Files')
            },
