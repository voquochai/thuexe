...
CKEDITOR.editorConfig = function( config ) {
	...
	config.extraPlugins = 'codemirror,lineheight,wenzgmap,youtube,googledocs,tableresize,imagerotate,youtube,entities,bootstrapVisibility,slideshow,locationmap,pastefromword,lightbox,imagebrowser,imagepaste,quicktable,image2,widget,widgetbootstrap,widgettemplatemenu,contextmenu,menu';
	// config.codemirror_theme = 'rubyblue';  // Go here for theme names: http://codemirror.net/demo/theme.html
	config.locationMapPath = 'public/packages/ckeditor/ckeditor/map/';
	...
	[
		...
		{ name: 'colors', items : [ 'TextColor','BGColor','Contextmenu','Menu' ] },
